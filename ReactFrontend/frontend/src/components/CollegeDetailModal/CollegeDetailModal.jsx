...
const modalVariants = {
    ...
    show: { opacity: 1, scale: 1, y: 0, transition: { type: 'spring', stiffness: 280, damping: 26 } },
            ...
            <div className="modal-scroll-body">
              ...
              <div className="modal-banner">
                ...
                <div className="modal-badges">
                  ...
                  {college.institutionType && (<span className="badge badge-type">
              ...
              <div className="modal-content">
                ...
                {/* Programmes Table */}
                {college.programmes && college.programmes.length > 0 && (<div className="modal-programmes">
                    ...
                    <div className="programme-table-wrap">
                      <table className="programme-table">
                        ...
                        <tbody>
                          {college.programmes.map((p) => (<tr key={p.id}>
                              <td>{p.programme || '—'}</td>
                              <td>{p.course || '—'}</td>
                              <td>{p.level || '—'}</td>
                              <td>{p.shift || '—'}</td>
                ...
                <div className="modal-cta">
                  <motion.button className="btn primary modal-cta-btn" whileHover={{ scale: 1.03, boxShadow: '0 8px 30px rgba(79,70,229,0.5)' }} whileTap={{ scale: 0.97 }} onClick={() => alert(`Redirecting to admission registration for ${college.instituteName}...`)}>
